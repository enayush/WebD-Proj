...
<body ng-app="">
    ...
    <div class="container" style="margin-top: 65px;">
        <div class="col-md-7" style="float: none; margin: 0 auto;">
            <div class="form-area">
                <form role="form" action="bookingconfirm.php" method="POST">
                    <br style="clear: both">
                    <h2 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Rent your dream car here
                    </h2><br>
                    ...
                    <!-- <h5> Choose your car type: &nbsp;
                        ...
                        <!-- <div ng-switch="myVar">
                            ...
                            <!-- <div ng-switch-when="ac"> -->
                                <!-- <div class="form-group"> -->
                                <h5>Fare:
                                    <?php echo ("₹" . $price . "/km and ₹" . $price_per_day . "/day"); ?>
                                    <h5>
                                        <!-- </div>    -->
                            <!-- </div> -->
            ...
            <h5> Choose charge type: &nbsp;
                ...
                <select name="driver_id_from_dropdown" ng-model="myVar1">
                    <?php
                    $sql2 = "SELECT * FROM driver d WHERE d.driver_availability = 'yes' AND d.emp_username IN (SELECT cc.emp_username FROM clientcars cc WHERE cc.car_id = '$car_id')";
                ...
                <div ng-switch="myVar1">
                    ...
                    <?php
                    $sql3 = "SELECT * FROM driver d WHERE d.driver_availability = 'yes' AND d.emp_username IN (SELECT cc.emp_username FROM clientcars cc WHERE cc.car_id = '$car_id')";
        ...
        <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
            <h6><strong>Kindly Note:</strong> You will be charged <span class="text-danger">₹200/-</span> for each day
                after the due date.</h6>
        </div>
    </div>
