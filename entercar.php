...
<body>
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Add Vehicle Details. </h3>
          ...
          <div class="form-group">
            <input type="text" class="form-control" id="price" name="price" placeholder="Fare per km (in rupees)" required>
          </div>

          

          <div class="form-group">
            <input type="text" class="form-control" id="price_per_day" name="price_per_day" placeholder="Fare per day (in rupees)" required>
          </div>
...
$sql = "SELECT * FROM cars WHERE car_id IN (SELECT car_id FROM clientcars WHERE emp_username='$user_check');";
...
<div style="overflow-x:auto;">
  ...
  <?php } ?>
    ...
    <br>
  <?php } else { ?>
  <h4><center>No Cars. Add Cars!!</center> </h4>
  <?php } ?>
        </form>
</div>        
        </div>
