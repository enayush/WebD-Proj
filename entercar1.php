<html>
  ...
  <head>
    <title> customer Signup | LAPS Car Rental </title>
  </head>
  <?php session_start(); ?>
...
$query = "INSERT into cars(car_name,car_nameplate,price,price_per_day,car_availability) VALUES('" . $car_name . "','" . $car_nameplate . "','" . $price . "','" . $price_per_day . "','" . $car_availability ."')";
...
if (!empty($_FILES["uploadedimage"]["name"])) {
    ...
    if(move_uploaded_file($temp_name, $target_path)) {
       ...
       $query0 = "UPDATE cars SET car_img = '$target_path' WHERE ";
        ...
        $query = "INSERT into cars(car_name,car_nameplate,car_img,price,price_per_day,car_availability) VALUES('" . $car_name . "','" . $car_nameplate . "','".$target_path."','" . $price . "','" . $price_per_day . "','" . $car_availability ."')";
        $success = $conn->query($query);
...
$query2 = "INSERT into clientcars(car_id,emp_username) values('" . $car_id ."','" . $_SESSION['login_client'] . "')";
